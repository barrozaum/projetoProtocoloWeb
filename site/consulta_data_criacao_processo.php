...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modal_data_criacao_processo.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formulario_consulta_data_criacao_processo.php');
