...
$codRequerente = $_REQUEST['requerente'];	

$decRequerente= $_REQUEST['nomeRequerente'];	
...
WHERE  cp.idRequerente = $codRequerente AND cp.idRequerente = r.idRequerente AND cp.idAssunto = a.idAssunto AND cp.dataProcesso >= '$dataAmericanaInicial' AND cp.dataProcesso <= '$dataAmericanaFinal' ORDER BY r.idRequerente  " ;
