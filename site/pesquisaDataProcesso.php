...
WHERE  c.dataProcesso >= '$dataAmericanaInicial' AND c.dataProcesso <= '$dataAmericanaFinal' AND c.idAssunto = a.idAssunto AND c.idRequerente = r.idRequerente ORDER BY idProcesso " ;
