...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modal_assunto.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formulario_cadastro_assunto.php');
                $('#listar').load('recursos/includes/listar/listar_assuntos.php');
