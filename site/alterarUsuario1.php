...
?>
	...
	?>
		...
		<script languagem="JavaScript">
         ...
         location.href="alterarUsuario.php?Usuario=<?php echo $txtUsuario; ?>";
		</script>
	...
	?>
			...
			$sql = "UPDATE usuario SET login = '$novoLogin', nome = '$nome', email = '$email', sobrenome =  '$sobrenome', idSetor = $setorTrabalho WHERE idUsuario = $txtUsuario  ";
			...
			?>	
				...
				?>	
				<script>window.alert('ALTERADO COM SUCESSO !!');location.href='alterarUsuario.php?Usuario=<?php echo $txtUsuario; ?>';</script>
				
				<?php 
				}else{
				?>
				<script>window.alert('ERRO AO ALTERAR PERMISSÃO !!');location.href='alterarUsuario.php?Usuario=<?php echo $txtUsuario; ?>';
				</script>
		...
		<?php }else{?>
			<script>window.alert('ERRO AO ALTERAR LOGIN !!');location.href='alterarUsuario.php?Usuario=<?php echo $txtUsuario; ?>';
				</script>
