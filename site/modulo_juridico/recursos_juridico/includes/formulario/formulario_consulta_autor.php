        ...
        <div class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
            <div class="well"><!-- div que coloca a cor no formulário -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading text-center">CONSULTA AUTOR PROCESSO</div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php
                                //   INPUT -                              
                                criar_input_text('AUTOR-PROCESSO', 'autor_processo', 'autor_processo', array('required' => 'true', 'maxlength' => '30', 'placeholder' => 'Informe o Autor do Processo'), '', 'Conter no Minimo 3 caracteres [a-z A-Z]');
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-success" id="id_buscar_autor">Procurar</button>
                            </div>
                        </div>
                    </div>
                </div>
