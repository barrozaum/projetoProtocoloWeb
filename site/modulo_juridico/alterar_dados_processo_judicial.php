...
//usandao sessao
$_SESSION['SESSION_ALTERAR_JUDICIAL'] = "true";
$_SESSION['SESSION_JUDICIAL_COD_PROCESSO'] = letraMaiuscula($_POST['txt_jud_cod_processo']);
    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $('#formulario').load('recursos_juridico/includes/formulario/formulario_alterar_juridico.php');
