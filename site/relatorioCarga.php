...
<head>
		...
		if (n == ""){
			window.alert("VERIFIQUE O CAMPO DESCRIÇÃO !!!");
			document.f1.numeroProcesso.focus();
		}else if (a == ""){
			window.alert("VERIFIQUE O CAMPO DESCRIÇÃO !!!");
			document.f1.anoProcesso.focus();
		}else
			document.f1.submit();
		...
		<div id="externo">
			...
			<div id="centro">
				...
				<div id="conteudo">
					...
					<br />
					<br />	
						<form name="f1"  action="relatorioCarga1.php" method="post">
						TIPO PROCESSO:
						...
						<label>ANO:
							<input type="text" id="ano" class="ano" name="anoProcesso" value="<?php echo date('Y'); ?>" maxlength="4" size="4px"/>
						</label>
