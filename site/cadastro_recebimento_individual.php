...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modal_cadastro_recebimento_individual.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formulario_cadastro_recebimento_individual.php');
