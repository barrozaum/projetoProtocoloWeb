        ...
        <div class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
            <div class="well"><!-- div que coloca a cor no formulário -->
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading text-center">CONSULTA ASSUNTO PROCESSO</div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php
                                //   INPUT -                              
                                criar_input_text('Assunto', 'assunto', 'assunto', array('required' => 'true'), '', '');
                                ?>
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <?php
                                //   INPUT -                              
                                criar_input_data('Data Inicial', 'data_inicial', 'data_inicial', array('required' => 'true', 'maxlength' => '3', 'placeholder' => '', 'onkeypress' => 'return SomenteNumero(event)'), '');
                                ?>
                            </div>
                            <div class="col-sm-6">
                                <?php
                                //   INPUT -                              
                                criar_input_data('Data Final', 'data_final', 'data_final', array('required' => 'true', 'maxlength' => '4', 'placeholder' => '', 'onkeypress' => 'return SomenteNumero(event)'), date('d/m/Y'));
                                ?>
                            </div>
                        </div> 
