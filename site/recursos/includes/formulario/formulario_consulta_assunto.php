                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php
                                //   INPUT -                              
                                criar_input_text_com_lupa('ASSUNTO', 'assunto', 'assunto', array('required' => 'true', 'maxlength' => '30', 'placeholder' => 'Informe o Assunto'), '', 'Conter no Minimo 3 caracteres [a-z A-Z]', 'lupa_assunto');
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-success" id="id_buscar_assunto">Procurar</button>
                            </div>
                        </div>
                    </div>
                </div>
