...
function formularioCadastro() {
    ...
    <form  method="post" action="recursos/includes/cadastrar/cadastrar_documento.php">    
        <div class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
            <div class="well"><!-- div que coloca a cor no formulário -->
                <div class="panel panel-default">
                    <!-- INICIO Dados do imóvel -->
                    <div class="panel-heading text-center">CADASTRO DOCUMENTO</div>
...
//    passa vetor nos campos
    ...
    <form method="post" action="recursos/includes/alterar/alterar_documento.php">    
...
//    passa vetor nos campos
    ...
    <form method="post" action="recursos/includes/excluir/excluir_documento.php">    
        ...
        <div class="modal-body">
            <p style="color: red">Deseja Prosseguir com a Exclusão do Documento ?</p>
