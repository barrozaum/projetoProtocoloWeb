        ...
        <div class="mainbox col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
            <div class="well"><!-- div que coloca a cor no formulário -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading text-center">RELAÇÃO DE PROCESSOS PARA RECEBIMENTO </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php
                                //   INPUT -                              
                                criar_input_text_com_lupa('SETOR ORIGEM', 'setor', 'setor', array('readonly' => 'true' , 'required' => 'true', 'maxlength' => '30', 'placeholder' => 'INFORME O SETOR DE ORIGEM PROCESSO'), '', 'Conter no Minimo 3 caracteres [a-z A-Z]', 'lupa_setor');
...
//                        se usuario == adm mostra o setor de origem que ele quer ficar
                        if ($_SESSION['LOGADO_PERFIL_USUARIO'] == 1) {
                            ...
                            criar_input_text_com_lupa('SETOR DESTINO', 'alterar_colaborador_setor', 'alterar_colaborador_setor', array('readonly' => 'true', 'maxlength' => '30', 'placeholder' => 'ADMINISTRADOR INFORME SETOR DESTINO PROCESSO'), '', '', 'lupa_setor_usuario');
