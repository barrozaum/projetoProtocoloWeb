...
function formulario() {
   ...
   <form  method="post" action="recursos/includes/relatorio/relatorio_processo_no_setor.php" id="id_formulario_processo" target="_blank">    
        ...
        <div class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0"> <!-- div que posiciona o formulário na tela -->
            <div class="well"><!-- div que coloca a cor no formulário -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading text-center">RELAÇÃO DE PROCESSOS NO SETOR </div>
