        ...
        <head>
            ...
            <script languagem = "JavaScript">
                function opcao_selecionada(codigo, descricao) {
                    opener.document.getElementById('id_codigo_origem').value = codigo;
                    opener.document.getElementById('id_origem').value = descricao;
                    window.close();
                }
            </script>
            <script>
            ...
            <div id="carregamento">
                <script>
                    $(document).ready(function () {
                        ...
                        $('#carregamento').load('selecionar_origem.php?janela=2');
                    });
                </script>
            </div>
        </body>
    ...
    <table id="table" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            for ($i = 0; $dados = $query->fetch(); $i++) {
                ...
                <tr>
                    <td height="5" align ="center"><input type="radio" name="op" onclick="opcao_selecionada('<?php echo $dados['idOrigem']; ?>', '<?php echo $dados['descricao_origem']; ?>');"> </td>  
