...
//      Comando sql a ser executado  
        $sql = "INSERT INTO origem (idOrigem, descricao_origem, idUsuario) VALUES (null, '$descricao', {$_SESSION['LOGIN_ID_USUARIO']})";
//        print $sql;
...
//          lanço erro na tela
        ...
        } else if (fun_log_origem($pdo, 'I', $sql) == FALSE) {
...
//        fecho conexao
        ...
        <script>
            window.alert("<?php echo "Origem Cadastrada com Sucesso !!!"; ?> ");
