...
<html lang="pt">
    <head>
        ...
        <script src="recursos/js/modal_setor.js"></script>
        ...
        <script>
            ...
            function estruturaPagina() {
                $('#formulario').load('recursos/includes/formulario/formulario_cadastro_setor.php');
                $('#listar').load('recursos/includes/listar/listar_setores.php');
